...
var posts = null;
    ...
    var mentions = [
      {
        ...
        post_desc:'Look at these shoes that Love Note Bride had on sale! Thank you @lovenotebride',
      ...
      },
      {
        ...
        post_desc:'Thank you @lovenotebride for giving me my dream dress! You guys did a great job!',
      ...
      },
      {
        ...
        post_desc:"I don't know what I love more... My wife or her dress from @lovenotebride",
  ...
  if (sectionType === "Scheduled Posts"){
    var posts = "insert div here when done";
